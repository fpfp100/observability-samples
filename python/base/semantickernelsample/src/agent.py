...
async def on_message(context: TurnContext, _state: TurnState):
    ...
    # Register observability token cache
    ...
    try:
        ...
        try:
            with invoke_scope:
                ...
                # Call Semantic Kernel - inference tracing handled by SemanticKernelInstrumentor
                ai_response = await call_semantic_kernel(user_message, context)
