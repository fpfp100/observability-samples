...
async def on_message(context: TurnContext, _state: TurnState):
    ...
    # Register observability token cache BEFORE creating any scopes.
    # This stores the TurnContext + Authorization so AgenticTokenCache can
    # do OBO token exchange when the exporter needs a Bearer token.
