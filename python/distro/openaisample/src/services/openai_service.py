...
from microsoft.opentelemetry.a365.core import InferenceCallDetails, InferenceOperationType, InferenceScope
...
async def call_azure_openai(user_message: str, context: TurnContext) -> str:
    ...
    request_details = create_request_details(user_message)
