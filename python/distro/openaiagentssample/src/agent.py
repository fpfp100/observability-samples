...
async def on_message(context: TurnContext, _state: TurnState):
    """Handle incoming messages and respond using the OpenAI Agents SDK."""
    ...
    try:
        ...
        try:
            with invoke_scope:
                ...
                # Cache the agentic token for exporter use
                cache_agentic_token(
                ...
                # Call the OpenAI Agents SDK -- auto-instrumented by OpenAIAgentsInstrumentor.
                # No manual InferenceScope needed; the instrumentor creates spans automatically.
                ai_response = await call_openai_agents(user_message)
