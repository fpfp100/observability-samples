...
def start_server(agent_application: AgentApplication, auth_configuration: AgentAuthConfiguration):
    ...
    # Enable LangChain auto-instrumentation via the distro's LangChainInstrumentor.
    # This automatically traces all LangChain invocations (LLM calls, chains, etc.)
    # so no manual InferenceScope is needed in the LangChain service.
